...
class LeroymerlinruSpider(scrapy.Spider):
    ...
    def parse(self, response: HtmlResponse):
        next_page = response.css('a[data-qa-pagination-item="right"]')[0]
        if next_page:
    ...
    def product_parse(self, response: HtmlResponse):
        ...
        loader.add_css('name', '#nav-description strong::text')
        loader.add_css('photos', "img[slot='thumbs']::src")
        loader.add_css('params', 'h1::text')
